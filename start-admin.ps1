Write-Host "正在启动童伴桥管理员后台开发服务器..." -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "启动管理员后台开发服务器..." -ForegroundColor Green
Write-Host "管理员后台地址：http://localhost:3001" -ForegroundColor Cyan
Write-Host "管理员登录页面：http://localhost:3001/admin-login" -ForegroundColor Cyan
Write-Host ""
