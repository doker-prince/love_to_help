Write-Host "正在启动童伴桥用户前台开发服务器..." -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "启动用户前台开发服务器..." -ForegroundColor Green
Write-Host "用户前台地址：http://localhost:3000" -ForegroundColor Cyan
Write-Host "用户登录页面：http://localhost:3000/login" -ForegroundColor Cyan
Write-Host "机构登录页面：http://localhost:3000/login" -ForegroundColor Cyan
Write-Host ""
